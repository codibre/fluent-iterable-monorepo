	...
	describe('iterable', () => {
		describe('sync', () => {
			it('should unwind specified properties', () => {
				...
				expect(result[0]!.value).toBe(payload[0]);
				expect(result[1]!.value).toBe(payload[0]);
				expect(result[2]!.value).toBe(payload[0]);
				expect(result[3]!.value).toBe(payload[0]);
				expect(result[4]!.value).toBe(payload[0]);
				expect(result[5]!.value).toBe(payload[0]);

				expect(result[6]!.value).toBe(payload[1]);
				expect(result[7]!.value).toBe(payload[1]);
				expect(result[8]!.value).toBe(payload[1]);
				expect(result[9]!.value).toBe(payload[1]);

				expect(result[10]!.value).toBe(payload[2]);
				expect(result[11]!.value).toBe(payload[2]);
				expect(result[12]!.value).toBe(payload[2]);
				expect(result[13]!.value).toBe(payload[2]);
			});
